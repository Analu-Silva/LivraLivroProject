...
export function handleSummary(data) {
    return {
        "C:/Dev/LivraLivro - Tests/k6/reports/html/load_test_report.html": htmlReport(data, { debug: false }),
    };
}
...
export const options = {
  stages: [
    { duration: '30s', target: 10 }, // rampa para 10 usuários
    { duration: '2m', target: 10 },  // mantém carga
    { duration: '30s', target: 0 },  // rampa para zero
  ],
  thresholds: {
    http_req_duration: ['p(95)<1200'], // 95% das requests < 1200ms
    checks: ['rate>0.95'],
  }
};
